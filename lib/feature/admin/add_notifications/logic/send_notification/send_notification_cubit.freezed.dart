...
abstract class _Loading implements SendNotificationState {
  const factory _Loading({required final int indexId}) = _$LoadingImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'SendNotificationState.failure(errorHandler: $errorHandler)';
  }
...
abstract class _Error implements SendNotificationState {
