...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.productDetailsModel});
...
abstract class _Loaded implements ProductDetailsState {
  const factory _Loaded(
      {required final ProductDetailsModel productDetailsModel}) = _$LoadedImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'ProductDetailsState.failure(errorHandler: $errorHandler)';
  }
